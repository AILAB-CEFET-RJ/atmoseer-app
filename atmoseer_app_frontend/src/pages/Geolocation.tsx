    ...
    <div className='flex justify-center'>
      <div className="flex justify-flex justify-center items-center min-h-screen w-4/5">
        <div className="flex flex-col items-center bg-[#f0f8ffcc] rounded-2xl px-4 py-2 shadow-md">
            ...
            forecastError || openMeteoError ? (
              ...
              <div className='grid grid-cols-2 mt-2 gap-1'>
                ...
                <div className="flex items-center justify-start p-0.5 rounded-lg shadow-sm bg-white gap-2">
                  ...
                  <div>
                    <h2 className='ml-2 mt-1 text-base font-semibold'>Clima Atual</h2>
                ...
                <div className="flex items-center justify-start p-0.5 rounded-lg shadow-sm bg-white gap-2">
                  ...
                  <div>
                    <h2 className='ml-2 mt-1 text-base font-semibold'>Estação de Previsão</h2>
                    <p className="text-base text-gray-800 m-2">{placeName}</p>
                  </div>
                </div>
                <div className="flex items-center justify-start p-0.5 rounded-lg shadow-sm bg-white gap-2">
                  <TemperatureIcon temperature={openMeteoData?.temperature} className="text-2xl ml-2" />
                  <div>
                    <h2 className='ml-2 mt-1 text-base font-semibold'>Temperatura Atual</h2>
                    <p className="text-base text-gray-800 m-2">{openMeteoData?.temperature && `${openMeteoData.temperature} °C`}</p>
                  </div>
                </div>
                <div className="flex items-center justify-start p-0.5 rounded-lg shadow-sm bg-white gap-2">
                  <FontAwesomeIcon icon={faCloudArrowDown} className="text-gray-300 text-2xl ml-2" />
                  <div>
                    <h2 className='ml-2 mt-1 text-base font-semibold'>Nebulosidade</h2>
                    <p className="text-base text-gray-800 m-2">{openMeteoData?.cloud_cover && `${openMeteoData.cloud_cover} %`}</p>
                  </div>
                </div>
                <div className="flex items-center justify-start p-0.5 rounded-lg shadow-sm bg-white gap-2">
                  <FontAwesomeIcon icon={faTint} className="text-blue-400 text-2xl ml-2" />
                  <div>
                    <h2 className='ml-2 mt-1 text-base font-semibold'>Umidade</h2>
                    <p className="text-base text-gray-800 m-2">{openMeteoData?.humidity && `${openMeteoData.humidity} %`}</p>
                  </div>
                </div>
                <div className="flex items-center justify-start p-0.5 rounded-lg shadow-sm bg-white gap-2">
                  <FontAwesomeIcon icon={faWind} className="text-blue-300 text-2xl ml-2" />
                  <div>
                    <h2 className='ml-2 mt-1 text-base font-semibold'>Velocidade do Vento</h2>
                    <p className="text-base text-gray-800 m-2">{openMeteoData?.wind_speed && `${openMeteoData.wind_speed} km/h`}</p>
                  </div>
                </div>
                <div className="flex items-center justify-start p-0.5 rounded-lg shadow-sm bg-white gap-2">
                  <FontAwesomeIcon icon={faLocationArrow} className="text-gray-400 text-2xl ml-2" />
                  <div>
                    <h2 className='ml-2 mt-1 text-base font-semibold'>Direção do Vento</h2>
          ...
          <Link to="/home" className="inline-block px-4 py-2 mt-2 rounded text-white font-bold no-underline bg-blue-500 hover:bg-blue-600 transition-colors" onClick={resetData}>Voltar</Link>        </div>
      </div>
    </div>
  );
};
